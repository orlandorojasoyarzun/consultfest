...
<head>
    ...
    <title>Recuperar contraseña - Consultfest</title>
        ...
        <div class="w-full max-w-md">
            <div class="text-center mb-10">
                <h1 class="text-3xl md:text-4xl font-semibold tracking-tight mb-3">
                    <span class="font-display italic font-normal">Recuperar contraseña</span>
                </h1>
            ...
            <form action="{{ route('auth.password.email') }}" method="POST" class="space-y-4">
                @csrf
